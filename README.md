...
La aplicación permite ingresar los datos necesarios de una persona y calcular el valor estimado de su pensión, teniendo en cuenta las semanas cotizadas, la edad, el sexo, el ingreso base de cotización y el salario mínimo legal vigente.
...
La estructura del proyecto contempla el directorio controller para la capa encargada de coordinar las diferentes partes de la aplicación.
...
La edad mínima utilizada por el sistema es:
...
La relación se obtiene dividiendo el IBL entre el salario mínimo legal vigente.
...
Si todas las pruebas son correctas, se mostrará un resultado indicando que los tests fueron ejecutados satisfactoriamente.

Ejecución de la aplicación

Para ejecutar la interfaz de consola, se debe abrir una terminal ubicada en la carpeta raíz del proyecto.

Se puede ejecutar el archivo principal con:
...
El proyecto utiliza Git como sistema de control de versiones y GitHub como plataforma para alojar el repositorio.
